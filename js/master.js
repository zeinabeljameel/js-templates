...
liColors.forEach((ele)=> {
    ele.onclick = ()=> {
        if(ele.getAttribute('data-color') === "#009688" && ele.className === 'active') {
            let landingPageImg = document.querySelector('.layer .transparent-layer')
            landingPageImg.src= "/imgs/lyer2.png";
        }
        else if(ele.getAttribute('data-color') === "#a80e42" && ele.className === 'active') {
            let landingPageImg = document.querySelector('.layer .transparent-layer')
            landingPageImg.src= "/imgs/pink-mask.png";
        }
        else if(ele.getAttribute('data-color') === "#14555f" && ele.className === 'active') {
            let landingPageImg = document.querySelector('.layer .transparent-layer')
            landingPageImg.src= "/imgs/dark-blue-mask3.png";
        }
    }
})
